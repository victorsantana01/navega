      ...
      <div class="card-body">
        <div class="text-center mt-4 mb-5">
          ...
          <%
              ...
              /*
     ConsumoDao cons = new ConsumoDao();
         cons.faixa(nome, rpm500r + "," + rpm600r + "," + rpm700r + "," + rpm800r + "," + rpm900r + "," + rpm1000r + "," + rpm1100r + ","
                 + rpm1200r + "," + rpm1300r + "," + rpm1400r + "," + rpm1500r + "," + rpm1600r + "," + rpm1700r + "," + rpm1800r + "," + rpm1900r + "," + rpm2000r + "," + rpm2100r + "," + rpm2200r + "," + rpm2300r + "," + rpm2400r + "," + rpm2500r + "," + rpm2600r + "," + rpm2700r + "," + rpm2800r + "," + rpm2900r + "," + rpm3000r,
                 rpm500 + "," + rpm600 + "," + rpm700 + "," + rpm800 + "," + rpm900 + "," + rpm1000 + "," + rpm1100 + ","
                 + rpm1200 + "," + rpm1300 + "," + rpm1400 + "," + rpm1500 + "," + rpm1600 + "," + rpm1700 + "," + rpm1800 + "," + rpm1900 + "," + rpm2000 + "," + rpm2100 + "," + rpm2200 + "," + rpm2300 + "," + rpm2400 + "," + rpm2500 + "," + rpm2600 + "," + rpm2700 + "," + rpm2800 + "," + rpm2900 + "," + rpm3000, descricao);
        */
