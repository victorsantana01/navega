...
<!-- START LEFT SIDEBAR NAV-->
           ...
           <ul id="menu-mobile" class="side-nav" style="width: 300px">
               ...
               <li>
                   ...
                   <div class="container">
                     ...
                     <select class="browser-default" name="mct" id="mct" >
        ...
        <div id="btnPesquisa" class="row"><br>
           ...
           <div class="col s12 ">
               <a id="btnxxx" onclick ='confirma(filtro)' class="button-collapse right  btn-floating blue pulse z-depth-5 btn-large"><i class="material-icons">search</i></a>    
           </div>
        ...
        <div id="areaRelatorio" class=" container "><br>
            <div id="areaRelatorio" class="row ">
                ...
                <div class="col s12">
                            ...
                            <div class=""  id="divCorpo" style="display: <%=parametro%>">
...
//alert(rpm);
                    ...
                    String mct = <%=viagem[7][0]%>;
                    String motor = <%=viagem[9][0]%>;
         ...
         <script type="text/javascript">
             ...
             console.log(mct);
             console.log(motor);
                 $('input[name="dataInicio"]').val(inicio);
                 $('input[name="dataFim"]').val(fim);
                 $('#mct').val(mct);
                 $('#selectService').val(motor);
                 form.submit();
                 return false;   
             }
